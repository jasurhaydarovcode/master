...
function SocialCard() {
  return (
    <a href='https://t.me/Abdulaziz_saidov' className="rounded-2xl flex items-center p-2 w-64  rel generall__border hover:scale-105 transition-all headshadow__fourth">
